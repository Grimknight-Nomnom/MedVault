...
<head>
    ...
    <title>Reset Password - Barangay Looc Clinic</title>
            ...
            <div class="relative z-10 h-full flex flex-col justify-center">
                <div class="mb-10">
                    ...
                    <p class="text-teal-100 text-lg leading-relaxed opacity-90 max-w-md">
                        Restore access to your MedVault account securely. We prioritize the privacy and security of your health data.
                    </p>
                </div>
            </div>
            ...
            <div class="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24">
                <div class="w-full max-w-md mx-auto">
                    ...
                    <div class="mb-10">
                        ...
                        <p class="mt-2 text-gray-500">Create a new secure password for your account.</p>
                    </div>
