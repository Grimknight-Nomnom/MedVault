...
<head>
    ...
    <title>Verify Code - Barangay Looc Clinic</title>
        ...
        <div class="hidden lg:flex lg:w-5/12 relative bg-teal-900 flex-col justify-between overflow-hidden p-12 text-white">
            ...
            <div class="relative z-10 h-full flex flex-col justify-center">
                 <div class="mb-10">
                    ...
                    <h2 class="text-2xl font-medium text-teal-200 mb-6">Verification</h2>
                    <p class="text-teal-100 text-lg leading-relaxed opacity-90 max-w-md">Please check your email inbox (and spam folder) for the verification code.</p>
                </div>
            </div>
                ...
                <div class="w-full max-w-md mx-auto">
                    ...
                    <form method="POST" action="{{ route('password.verify.post') }}" class="space-y-6">
                        ...
                        <div class="space-y-1.5">
                            <label for="code" class="block text-sm font-semibold text-gray-700">Verification Code</label>
                            <input id="code" name="code" type="text" placeholder="123456" maxlength="6" required autofocus
                                class="block w-full px-4 py-3 rounded-xl border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition-all duration-200 outline-none placeholder:text-gray-400 sm:text-sm text-center tracking-widest text-2xl font-bold">
